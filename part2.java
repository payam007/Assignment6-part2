...
jtxtField[0].setForeground(Color.Green);
jtxtField[0].setBackground(Color.Black);
jtxtField[1]= new JTextField(" Tuesday ");
jtxtField[1].setForeground(Color.Green);
jtxtField[1].setBackground(Color.Black);
jtxtField[2]= new JTextField(" Wednesday ");
jtxtField[2].setForeground(Color.Green);
jtxtField[2].setBackground(Color.Black);
jtxtField[3]= new JTextField(" Thursday ");
jtxtField[3].setForeground(Color.Green);
jtxtField[3].setBackground(Color.Black);
jtxtField[4]= new JTextField(" Friday ");
jtxtField[4].setForeground(Color.Green);
jtxtField[4].setBackground(Color.Black);
jtxtField[5]= new JTextField(" Saturday ");
jtxtField[5].setForeground(Color.Green);
jtxtField[5].setBackground(Color.Black);
jtxtField[6]= new JTextField(" Sunday ");
jtxtField[6].setForeground(Color.Green);
jtxtField[6].setBackground(Color.Black);
